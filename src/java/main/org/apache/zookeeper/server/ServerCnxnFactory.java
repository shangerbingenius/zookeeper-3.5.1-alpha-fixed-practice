...
public abstract class ServerCnxnFactory {
    ...
    public static final String ZOOKEEPER_4LW_COMMANDS_WHITELIST = "zookeeper.4lw.commands.whitelist";

    private static final Logger LOG = LoggerFactory.getLogger(ServerCnxnFactory.class);

    // Tells whether SSL is enabled on this ServerCnxnFactory
    protected boolean secure;
    //White listed 4 letter word commands
    private Set<String> whiteListedCommands = new HashSet<String>();
    /**
    ...
    protected void initWhiteListedCommands() {
     ...
     *
     * @param cmd
     *            4 letter word command
     * @return true if given command is white listed 4 letter world command
     */
    public boolean isWhiteListedCommand(String cmd) {
