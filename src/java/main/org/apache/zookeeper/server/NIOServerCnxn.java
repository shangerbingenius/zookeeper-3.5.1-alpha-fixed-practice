...
import org.apache.zookeeper.server.command.ErrorCommand;
...
public class NIOServerCnxn extends ServerCnxn {
    ...
    throws IOException
    {
        ...
        if (!factory.isWhiteListedCommand(cmd)) {
            // Error command sends error message to the user
                    ErrorCommand errorCmd = new ErrorCommand(pwriter, this, cmd + " is blocked.");
            errorCmd.start();
            return true;
        }
